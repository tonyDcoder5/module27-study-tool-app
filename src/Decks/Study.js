    ...
    return (
      <div className="container"> 
        ...
        <div>
          ...
          <span>You need at least 3 cards to study. There are {deck.cards.length} card(s) in this deck.</span>
          <div className="mt-3"><Link to={`/decks/${deck.id}/cards/new`}><button className="btn btn-primary">+ Add Cards</button></Link></div>
        </div>
        </div>
    );
  }
      ...
      <div className="container">
        ...
        <div className="card">
          ...
          <div className="mt-3">
            ...
            {side && <button className="btn btn-primary ml-1" onClick={nextCard}>Next</button>}
          </div>
          </div>
        </div>
      </div>
